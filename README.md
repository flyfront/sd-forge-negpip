...
The former `neo-krea2` branch (NegPiP without V-Scaling) is frozen. This branch behaves the same way while the **NegPiP V-Scaling (Krea 2)** accordion is closed, and it receives all further fixes.
